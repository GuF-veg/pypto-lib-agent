...
def _q_proj_rope_tile(
    ...
    """Project one dense token tile through Q LoRA, RMSNorm, quantization, and RoPE."""
...
def _kv_proj_rope_tile(
    ...
    """Project one dense token tile through KV LoRA, RMSNorm, and RoPE."""
    t_dim = pl.tensor.dim(x, 0)
    x_view = pl.reshape(x, [t_dim, D])
