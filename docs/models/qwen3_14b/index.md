...
The production attention stage is generated from
...
are ordered `[page, token, kv_head, dim]`.

The original hand-written CCE implementation remains available as a standalone
reference and regression target. [paged_attention_cce.py](../../../models/qwen3_14b/paged_attention_cce.py)
binds the kernel under
[kernels/paged_attention_cce/](../../../models/qwen3_14b/kernels/paged_attention_cce/)
through `pl.jit.extern`, while
