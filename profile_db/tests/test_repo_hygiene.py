...
LAYERS: dict[str, int] = {
    ...
    "profile_db.query": 4,
    "profile_db.query.registry": 4,
    "profile_db.query.params": 4,
    "profile_db.query.result": 4,
    "profile_db.query.common": 4,
    "profile_db.query.handlers_z0": 4,
    "profile_db.query.handlers_z1": 4,
    ...
    "profile_db.render": 2,
    "profile_db.render.styles": 2,
    "profile_db.render.types": 2,
    "profile_db.render.renderers": 2,
    "profile_db.render.cache": 2,
    "profile_db.db": 3,
    "profile_db.facts": 2,
    "profile_db.schema": 1,
    "profile_db.errors": 0,
...
# likewise: the handlers share registry/params/common; render likewise:
# the orchestrator shares styles/types/renderers/cache).
_SIBLING_PREFIXES = {
    "profile_db.ingest",
    "profile_db.derived",
    "profile_db.query",
